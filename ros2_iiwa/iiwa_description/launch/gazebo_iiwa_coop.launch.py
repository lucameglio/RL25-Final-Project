...
def generate_launch_description():
    ...
    delay_gripper_controller_spawner_after_jsb = RegisterEventHandler(
        event_handler=OnProcessExit(
            target_action=joint_state_broadcaster_spawner,
    ...
    bridge = Node(
        ...
        name='gz_bridge',
        arguments=[
            '/iiwa_cam/image_raw@sensor_msgs/msg/Image@gz.msgs.Image',
            '/iiwa_cam/camera_info@sensor_msgs/msg/CameraInfo@gz.msgs.CameraInfo',
            
           # '/world/aruco_world/set_pose@ros_gz_interfaces/srv/SetEntityPose@gz.msgs.Pose@gz.msgs.Boolean',
            
            # '--ros-args', '--remap', '/iiwa_cam/image_raw:=/iiwa_cam/videocamera',
            # '--ros-args', '--remap', '/iiwa_cam/camera_info:=/iiwa_cam/videocamera_info'  
        ],
        output='screen'
    )
    ...
    static_tf = Node(
        ...
        name='map_to_world',
        arguments=['0', '3', '0', '0', '0', '0', 'map', 'world']
    )
    ...
    nodes = [
        ...
        delay_gripper_controller_spawner_after_jsb,
        bridge,
        static_tf
    ]
